...
class RippleDrawableBuilder {

    private var color: Int = Constants.COLOR_DEFAULT
    ...
    fun drawable(drawable: Drawable): RippleDrawableBuilder = apply { this.drawable = drawable }
